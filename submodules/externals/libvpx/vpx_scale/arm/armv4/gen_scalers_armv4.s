...
@)
_horizontal_line_4_5_scale_armv4:
...
hl45_loop:
    ...
    ldmia   sp!, {r4 - r11, pc}
	.size horizontal_line_4_5_scale_armv4, .-horizontal_line_4_5_scale_armv4    @ ENDP    @|vp8cx_horizontal_line_4_5_scale_c|
...
@)
_vertical_band_4_5_scale_armv4:
...
vl45_loop:
    ...
    ldmia   sp!, {r4 - r11, pc}
	.size vertical_band_4_5_scale_armv4, .-vertical_band_4_5_scale_armv4    @ ENDP    @|vertical_band_4_5_scale_armv4|
...
@)
_horizontal_line_2_3_scale_armv4:
...
hl23_loop:
    ...
    ldmia   sp!, {r4 - r11, pc}
	.size horizontal_line_2_3_scale_armv4, .-horizontal_line_2_3_scale_armv4    @ ENDP    @|horizontal_line_2_3_scale_armv4|
...
@   r2 = UINT32 dest_width
@)
_vertical_band_2_3_scale_armv4:
...
vl23_loop:
    ...
    ldmia   sp!, {r4 - r8, pc}
	.size vertical_band_2_3_scale_armv4, .-vertical_band_2_3_scale_armv4    @ ENDP    @|vertical_band_2_3_scale_armv4|
...
@   unsigned int dest_width
@)
_horizontal_line_3_5_scale_armv4:
...
hl35_loop:
    ...
    ldmia   sp!, {r4 - r11, pc}
	.size horizontal_line_3_5_scale_armv4, .-horizontal_line_3_5_scale_armv4    @ ENDP    @|vp8cx_horizontal_line_3_5_scale_c|
...
@   r2 = UINT32 dest_width
@)
_vertical_band_3_5_scale_armv4:
...
vl35_loop:
    ...
    ldmia   sp!, {r4 - r11, pc}
	.size vertical_band_3_5_scale_armv4, .-vertical_band_3_5_scale_armv4    @ ENDP    @|vertical_band_3_5_scale_armv4|
...
@   unsigned int dest_width
@)
_horizontal_line_3_4_scale_armv4:
...
hl34_loop:
    ...
    ldmia   sp!, {r4 - r11, pc}
	.size horizontal_line_3_4_scale_armv4, .-horizontal_line_3_4_scale_armv4    @ ENDP    @|vp8cx_horizontal_line_3_4_scale_c|
...
@   r2 = UINT32 dest_width
@)
_vertical_band_3_4_scale_armv4:
...
vl34_loop:
    ...
    ldmia   sp!, {r4 - r11, pc}
	.size vertical_band_3_4_scale_armv4, .-vertical_band_3_4_scale_armv4    @ ENDP    @|vertical_band_3_4_scale_armv4|
...
@   unsigned int dest_width
@)
_horizontal_line_1_2_scale_armv4:
...
hl12_loop:
    ...
    ldmia   sp!, {r4 - r5, pc}
	.size horizontal_line_1_2_scale_armv4, .-horizontal_line_1_2_scale_armv4    @ ENDP    @|vertical_band_3_5_scale_armv4|
...
@   r2 = UINT32 dest_width
@)
_vertical_band_1_2_scale_armv4:
...
vl12_loop:
    ...
    ldmia   sp!, {r4 - r7, pc}
	.size vertical_band_1_2_scale_armv4, .-vertical_band_1_2_scale_armv4    @ ENDP    @|vertical_band_3_5_scale_armv4|
