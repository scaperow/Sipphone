...
@                   r0  r1  r2  r3  r4  r5  r6  r7  r8  r9  r10 r11 r12     r14
    .global vp8_short_idct4x4llm_1_v6 
	.type vp8_short_idct4x4llm_1_v6, function
    .global vp8_short_idct4x4llm_v6 
	.type vp8_short_idct4x4llm_v6, function
    .global vp8_short_idct4x4llm_v6_scott 
	.type vp8_short_idct4x4llm_v6_scott, function
    .global vp8_short_idct4x4llm_v6_dual 
	.type vp8_short_idct4x4llm_v6_dual, function
...
_vp8_short_idct4x4llm_1_v6:
	...
	.size vp8_short_idct4x4llm_1_v6, .-vp8_short_idct4x4llm_1_v6    @ ENDP        @ |vp8_short_idct4x4llm_1_v6|
@********************************************************************************
@********************************************************************************
@********************************************************************************
...
returnfull:          @
	...
	.size vp8_short_idct4x4llm_v6, .-vp8_short_idct4x4llm_v6    @ ENDP
...
_vp8_short_idct4x4llm_v6_scott:
...
short_idct4x4llm_v6_scott_loop2:          @
    ...
    bne short_idct4x4llm_v6_scott_loop2  @
            @
    ldmia   sp!, {r4 - r11, pc} @
	.size vp8_short_idct4x4llm_v6_scott, .-vp8_short_idct4x4llm_v6_scott    @ ENDP        @
            @
@********************************************************************************
@********************************************************************************
@********************************************************************************
...
@@@@@   subs    r5, r5, #0x1    @ i--                           --
    bne loop2_dual  @
            @
    ldmia   sp!, {r4 - r11, pc} @ replace vars, return                      restore
	.size vp8_short_idct4x4llm_v6_dual, .-vp8_short_idct4x4llm_v6_dual    @ ENDP
