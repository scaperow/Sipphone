...
@
    ...
    @.global vp8_loop_filter_simple_horizontal_edge_neon 
	.type vp8_loop_filter_simple_horizontal_edge_neon, function
    .global vp8_loop_filter_bhs_neon 
	.type vp8_loop_filter_bhs_neon, function
    .global vp8_loop_filter_mbhs_neon 
	.type vp8_loop_filter_mbhs_neon, function
   @ ARM
   @ PRESERVE8
...
_vp8_loop_filter_simple_horizontal_edge_neon:
    ...
    bx          lr
	.size vp8_loop_filter_simple_horizontal_edge_neon, .-vp8_loop_filter_simple_horizontal_edge_neon    @ ENDP        @ |vp8_loop_filter_simple_horizontal_edge_neon|

@ r0    unsigned char *y
@ r1    int ystride
@ r2    const unsigned char *blimit

_vp8_loop_filter_bhs_neon:
	...
	.size vp8_loop_filter_bhs_neon, .-vp8_loop_filter_bhs_neon    @ ENDP        @|vp8_loop_filter_bhs_neon|

@ r0    unsigned char *y
@ r1    int ystride
@ r2    const unsigned char *blimit

_vp8_loop_filter_mbhs_neon:
	vp8_loop_filter_mbhs_neon: @ PROC
    ldrb        r3, [r2]                   @ load blim from mem
    vdup.s8     q1, r3                     @ duplicate mblim
    b           vp8_loop_filter_simple_horizontal_edge_neon
	.size vp8_loop_filter_mbhs_neon, .-vp8_loop_filter_mbhs_neon    @ ENDP        @|vp8_loop_filter_bhs_neon|
