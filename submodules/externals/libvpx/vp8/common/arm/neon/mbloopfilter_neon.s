...
@
    ...
    .global vp8_mbloop_filter_horizontal_edge_y_neon 
	.type vp8_mbloop_filter_horizontal_edge_y_neon, function
    .global vp8_mbloop_filter_horizontal_edge_uv_neon 
	.type vp8_mbloop_filter_horizontal_edge_uv_neon, function
    .global vp8_mbloop_filter_vertical_edge_y_neon 
	.type vp8_mbloop_filter_vertical_edge_y_neon, function
    .global vp8_mbloop_filter_vertical_edge_uv_neon 
	.type vp8_mbloop_filter_vertical_edge_uv_neon, function
   @ ARM
...
_vp8_mbloop_filter_horizontal_edge_y_neon:
    ...
    pop         {pc}
	.size vp8_mbloop_filter_horizontal_edge_y_neon, .-vp8_mbloop_filter_horizontal_edge_y_neon    @ ENDP        @ |vp8_mbloop_filter_horizontal_edge_y_neon|
...
_vp8_mbloop_filter_horizontal_edge_uv_neon:
    ...
    pop         {pc}
	.size vp8_mbloop_filter_horizontal_edge_uv_neon, .-vp8_mbloop_filter_horizontal_edge_uv_neon    @ ENDP        @ |vp8_mbloop_filter_horizontal_edge_uv_neon|
...
@ r3    unsigned char limit
@ sp    unsigned char thresh,
_vp8_mbloop_filter_vertical_edge_y_neon:
    ...
    pop         {pc}
	.size vp8_mbloop_filter_vertical_edge_y_neon, .-vp8_mbloop_filter_vertical_edge_y_neon    @ ENDP        @ |vp8_mbloop_filter_vertical_edge_y_neon|
...
@ sp+4  unsigned char *v
_vp8_mbloop_filter_vertical_edge_uv_neon:
    ...
    pop         {pc}
	.size vp8_mbloop_filter_vertical_edge_uv_neon, .-vp8_mbloop_filter_vertical_edge_uv_neon    @ ENDP        @ |vp8_mbloop_filter_vertical_edge_uv_neon|
...
_vp8_mbloop_filter_neon:
    ...
    bx          lr
	.size vp8_mbloop_filter_neon, .-vp8_mbloop_filter_neon    @ ENDP        @ |vp8_mbloop_filter_neon|
