...
@
    ...
    .global vp8_fast_quantize_b_neon 
	.type vp8_fast_quantize_b_neon, function
    .global vp8_fast_quantize_b_pair_neon 
	.type vp8_fast_quantize_b_pair_neon, function
...
_vp8_fast_quantize_b_pair_neon:
	...
	.size vp8_fast_quantize_b_pair_neon, .-vp8_fast_quantize_b_pair_neon    @ ENDP

@void vp8_fast_quantize_b_c(BLOCK *b, BLOCKD *d)
_vp8_fast_quantize_b_neon:
...
zero_output:
	...
	.size vp8_fast_quantize_b_neon, .-vp8_fast_quantize_b_neon    @ ENDP

@ default inverse zigzag table is defined in vp8/common/entropy.c
_inv_zig_zag_:
    .long  inv_zig_zag

    .balign 16    @ enable use of ,:128 bit aligned loads
inv_zig_zag:
    .short  0x0001, 0x0002, 0x0006, 0x0007
    .short  0x0003, 0x0005, 0x0008, 0x000d
    .short  0x0004, 0x0009, 0x000c, 0x000e
    .short  0x000a, 0x000b, 0x000f, 0x0010
