...
@
    ...
    .global vp8_variance_halfpixvar16x16_h_neon 
	.type vp8_variance_halfpixvar16x16_h_neon, function
    .global vp8_variance_halfpixvar16x16_v_neon 
	.type vp8_variance_halfpixvar16x16_v_neon, function
    .global vp8_variance_halfpixvar16x16_hv_neon 
	.type vp8_variance_halfpixvar16x16_hv_neon, function
    .global vp8_sub_pixel_variance16x16s_neon 
	.type vp8_sub_pixel_variance16x16s_neon, function
   @ ARM
   @ 
   @ PRESERVE8
...
@)@
@================================================
_vp8_variance_halfpixvar16x16_h_neon:
...
vp8_filt_fpo16x16s_4_0_loop_neon:
    ...
    pop             {pc}
	.size vp8_variance_halfpixvar16x16_h_neon, .-vp8_variance_halfpixvar16x16_h_neon    @ ENDP
...
@)@
@================================================
_vp8_variance_halfpixvar16x16_v_neon:
...
vp8_filt_spo16x16s_0_4_loop_neon:
    ...
    vmov.32         r0, d0[0]                   @return
    pop             {pc}
	.size vp8_variance_halfpixvar16x16_v_neon, .-vp8_variance_halfpixvar16x16_v_neon    @ ENDP
...
@)@
@================================================
_vp8_variance_halfpixvar16x16_hv_neon:
...
vp8_filt16x16s_4_4_loop_neon:
    ...
    vmov.32         r0, d0[0]                   @return
    pop             {pc}
	.size vp8_variance_halfpixvar16x16_hv_neon, .-vp8_variance_halfpixvar16x16_hv_neon    @ ENDP
...
_vp8_sub_pixel_variance16x16s_neon:
...
sub_pixel_variance16x16s_neon_loop:
    ...
    pop             {r4, pc}
	.size vp8_sub_pixel_variance16x16s_neon, .-vp8_sub_pixel_variance16x16s_neon    @ ENDP
