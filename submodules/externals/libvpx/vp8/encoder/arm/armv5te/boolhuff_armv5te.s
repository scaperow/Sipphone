...
@
    ...
    .global vp8_start_encode 
	.type vp8_start_encode, function
    .global vp8_encode_bool 
	.type vp8_encode_bool, function
    .global vp8_stop_encode 
	.type vp8_stop_encode, function
    .global vp8_encode_value 
	.type vp8_encode_value, function
...
_vp8_start_encode:
    ...
    bx      lr
	.size vp8_start_encode, .-vp8_start_encode    @ ENDP
...
token_count_lt_zero:
    ...
    pop     {r4-r9, pc}
	.size vp8_encode_bool, .-vp8_encode_bool    @ ENDP
...
token_count_lt_zero_se:
	...
	.size vp8_stop_encode, .-vp8_stop_encode    @ ENDP
...
token_count_lt_zero_ev:
    ...
    str     r3, [r0, #vp8_writer_count]
    pop     {r4-r11, pc}
	.size vp8_encode_value, .-vp8_encode_value    @ ENDP
