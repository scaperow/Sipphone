...
public class CoreFactory extends LinphoneCoreFactory {
	...
	public LinphoneCore createLinphoneCore(LinphoneCoreListener listener,
		...
		try {
			return new PhoneCore(listener, new File(userConfig), new File(
					factoryConfig), userdata);
		} catch (IOException e) {
	...
	public LinphoneProxyConfig createProxyConfig(String identity, String proxy,
		...
		return new ProxyConfig(identity, proxy, route, enableRegister);
	}
