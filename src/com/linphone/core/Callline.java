...
class Callline implements LinphoneCall {
	 ...
	 */
	private Callline(long aNativePtr)  {
	...
	public LinphoneCallParams getCurrentParamsCopy() {
		return new CallParameter(getCurrentParamsCopy(nativePtr));
	}
	public LinphoneCallParams getRemoteParams() {
		return new CallParameter(getRemoteParams(nativePtr));
	}
	...
	public boolean equals(Object call) {
		...
		if (!(call instanceof Callline)) return false;
		return nativePtr == ((Callline)call).nativePtr;
	}
	...
	public boolean isInConference() {
		CallParameter params = new CallParameter(getCurrentParamsCopy(nativePtr));
