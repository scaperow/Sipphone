...
class ProxyConfig implements LinphoneProxyConfig {
	...
	protected ProxyConfig(String identity,String proxy,String route, boolean enableRegister) throws LinphoneCoreException {
	...
	protected ProxyConfig(long aNativePtr)  {
