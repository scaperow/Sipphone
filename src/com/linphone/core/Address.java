...
public class Address implements LinphoneAddress {
	...
	protected Address(String identity)  {
		nativePtr = newLinphoneAddressImpl(identity, null);
	}
	
	protected Address(String username,String domain,String displayName)  {
		nativePtr = newLinphoneAddressImpl("sip:"+username+"@"+domain, displayName);
	}
	protected Address(long aNativePtr,boolean javaOwnPtr)  {
		nativePtr = aNativePtr;
		ownPtr=javaOwnPtr;
	}
	protected Address(long aNativePtr)  {
		nativePtr = aNativePtr;
		ownPtr=false;
	}
