...
class Friend implements LinphoneFriend {
	...
	protected Friend(String friendUri)  {
		nativePtr = newLinphoneFriend(friendUri);
	}
	protected Friend(long aNativePtr)  {
	...
	public void setAddress(LinphoneAddress anAddress) {
		this.setAddress(nativePtr, ((Address)anAddress).nativePtr);
		
	}
	public LinphoneAddress getAddress() {
		return new Address(getAddress(nativePtr));
	}
